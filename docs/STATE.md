...
- 2026-08-15 — **AMH now runs and tests on the supported macOS, Linux, and Windows toolchains.**
  ...
  the runtime floor for macOS, GNU/Linux, and Windows Git Bash. Prepared as 7.0.1.
