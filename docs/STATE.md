...
This branch is **6.1.0** (MINOR): it adds Codex lifecycle hooks while retaining its static
permission rules, and includes the row-concision clarification originally staged for 6.0.1.
All five hand-maintained copies say 6.1.0; the tag is queued.
